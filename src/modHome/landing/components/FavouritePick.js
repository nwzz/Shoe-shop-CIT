...
const FavouritePick = () => {
  return (
    <div className="mt-20 mb-10 border-gray-200 border-b pb-5 ">
      <div className="mb-10 relative head-liner before:left-0 after:right-0 lg:before:left-60 lg:after:right-60">
            ...
            <Link to={`/products/${item.category}`}>
              <div className="overflow-hidden">
                <img
                  src={item.img}
                  alt=""
                  className="relative transition delay-150 duration-300  group-hover:scale-110 hover:opacity-75 mx-auto"
                />
